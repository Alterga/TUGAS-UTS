...
public class UpdateMinuman extends AppCompatActivity {
    ...
    private void getMinuman(){
        class GetMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("diavolopro.000webhostapp.com/tugasuts/Minuman/get_minuman.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMinuman(){
        ...
        class UpMinuman extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("http://diavolopro.000webhostapp.com/tugasuts/Minuman/update_minuman.php", hashMap);
    ...
    private void deleteMinuman(){
        class DeleteMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("http://diavolopro.000webhostapp.com/tugasuts/Minuman/delete_minuman.php?no=", id);
                return s;
            }
        }
